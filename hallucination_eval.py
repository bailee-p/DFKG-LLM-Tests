...
class HalluEvaluator:
    ...
    def test_summary():
        ...
        graph_path1 = "c:\\Users\\baile\\updated\\data\\1.json" # Path to your graph JSON file (original)
        graph_path2 = "c:\\Users\\baile\\updated\\AI_gen\\1_GEN.json"  # Path to your graph JSON file (dspy.pred graph)
        graph_path3 = "c:\\Users\\baile\\updated\\AI_gen\\1_COT.json" #dspy.cot graph

        halluEvaluator = HalluEvaluator(
            graph_pathA=graph_path1, graph_pathB=graph_path2
           # graph_pathA=graph_path1, graph_pathB=graph_path3
        )
        (num_insert_substitute_ops,
        num_nodes_edges,
        graph_hullucination,
